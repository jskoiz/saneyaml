...
fn flow_mapping_by_len(stream: &saneyaml::LosslessStream, len: usize) -> &saneyaml::LosslessNode {
    stream
        .nodes()
        .iter()
        .find(|node| {
...
fn flow_sequence_by_len(stream: &saneyaml::LosslessStream, len: usize) -> &saneyaml::LosslessNode {
    stream
        .nodes()
        .iter()
        .find(|node| {
