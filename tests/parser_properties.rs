...
fn fuzz_corpora_cover_release_targets_and_named_safety_seeds() {
    let expected: BTreeMap<&str, (usize, &[&str])> = BTreeMap::from([
        ...
        ("event_stream", (114, EVENT_STREAM_REQUIRED_SEEDS)),
        ("lossless_edit", (28, LOSSLESS_EDIT_REQUIRED_SEEDS)),
        ("lossless_graph", (32, LOSSLESS_GRAPH_REQUIRED_SEEDS)),
        ("parse_bytes", (898, PARSE_BYTES_REQUIRED_SEEDS)),
        ("schema_modes", (31, SCHEMA_MODES_REQUIRED_SEEDS)),
        ("serde_entrypoints", (299, SERDE_ENTRYPOINTS_REQUIRED_SEEDS)),
